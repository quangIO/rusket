...
void racket_easy_boot(const char *exec_file, const char *boot1_path,
                      const char *boot2_path, const char *boot3_path,
                      const char *collects_dir, const char *config_dir) {
  ...
  ba.collects_dir = "/Applications/Racket "
                    "v8.3/collects\0/Users/qt/Library/Racket/8.3/collects\0";
  ba.config_dir = "/Applications/Racket v8.3/etc";
  /* ba.collects_dir = collects_dir; */
  /* ba.config_dir = config_dir; */
  racket_boot(&ba);
}
...
void run_something(const char *image) {
  ...
  ptr mod = Scons(Sstring_to_symbol("quote"),
                  Scons(Sstring_to_symbol("evaluator"), Snil));
